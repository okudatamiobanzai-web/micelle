...
import { posts, resolvedPosts, type SamplePost } from "@/lib/sample-data";
...
export default function HomePage() {
  ...
  useEffect(() => {
    // Listen on the main element (parent) for scroll events
  ...
  const handleSelect = (post: SamplePost) => {
    router.push(`/help/${post.id}`);
  };

  const handleSkillSelect = (post: SamplePost) => {
    ...
    <div className="pb-20">
      ...
      >
        <div className="flex items-center justify-between">
          ...
          <button onClick={() => router.push("/notifications")} className="relative bg-transparent border-none cursor-pointer p-1">
