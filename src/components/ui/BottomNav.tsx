...
export function BottomNav() {
  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 flex border-t border-gray-100 bg-white/92 backdrop-blur-2xl pb-[env(safe-area-inset-bottom,8px)] z-20 max-w-[430px] mx-auto">
      {NAV_ITEMS.map((n) => {
